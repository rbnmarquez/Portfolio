      ...
      <div className="container">
        <div className="hero-grid">
          <div className="hero-portrait reveal">
            <img src="assets/headshot.jpg" alt="Robin Marquez" style={{ objectFit: "cover", height: "484px", opacity: "1" }} />
          </div>
          <div>
            ...
            <h1 className="hero-headline reveal delay-1">
              Humanizing AI through <span className="grad">strategic design.</span>
            </h1>
            <p className="hero-sub reveal delay-2">Bridging the gap between institutional strategy and user empathy to build high-impact, scalable products.
